...
public class ProductDetailedView extends AppCompatActivity {
    ...
    private void detailedView() {
        btnWishList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //If userLogged in then order otherWise go to login screen.
                ...
                if (userNameData.equals("")) {
                    ...
                    //if login then set data to preference helper to show in wishList
            ...
            public void onClick(View v) {
                ...
                if (proceed) {
                    if (userNameData.equals("")) {
                        ...
                        //if login then move item to cart.
    ...
    private void selectSize() {
        //Select size through radio Button..
        //If not selected then can't go forward and show toast.
